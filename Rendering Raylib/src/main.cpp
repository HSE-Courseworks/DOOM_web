...
int main()
{
    ...
    Vector2 pos_2;
    // pos_2.x = game.gameMap.getFrame().x + game.gameMap.getWallSize().x * 3 / 2.0f + 6;
    // pos_2.y = game.gameMap.getFrame().y + game.gameMap.getWallSize().y * 3 / 2.0f + 1;
    ...
    game.addPlayer(Player(pos_1, 0, softRed, "resources/player.png"));
    game.addPlayer(Player(pos_2, 180, softBlue, "resources/player.png"));
    game.addPlayer(Player(pos_3, 180, softPink, "resources/player.png"));
